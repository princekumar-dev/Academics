  ...
  event.waitUntil((async () => {
    ...
    let notifyPromise = (async () => {
      try {
        ...
        console.log(`📢 Broadcasting to ${allClients.length} client(s)...`);
        ...
        for (const client of allClients) {
          try {
            ...
            console.warn('Failed to send message to client:', err.message);
          }
        }
      } catch (e) {
        console.error('Error matching clients:', e.message);
      }
    })();
